document.addEventListener('DOMContentLoaded', function () {
    ...
    const searchBar = document.getElementById('product-searchbar');
    const pageSizeSelect = document.getElementById('products-per-page-select');
    const resetFiltersButton = document.getElementById('reset-product-filters-button');
    ...
    function selectProduct(productName, productID) {
      ...
      showModal('Product', selectedProduct, selectedProductID);
    }
    ...
    productContainer.addEventListener('click', (event) => {
        ...
        const card = event.target.closest('.product-card-static');
        if (event.target.classList.contains('product-card-static')) {
